...
#include "Guids.h"
#include "..\doorfail.zethos.extensionUI\Resource.h"

#include "..\doorfail.zethos.extensionUI\CommandIds.h"
...
class ATL_NO_VTABLE Cdoorfail_zethos_extensionPackage : 
	...
	public CComCoClass<Cdoorfail_zethos_extensionPackage, &CLSID_doorfail_zethos_extension>,
	// Provides the implementation for IVsPackage to make this COM object into a VS Package.
	public IVsPackageImpl<Cdoorfail_zethos_extensionPackage, &CLSID_doorfail_zethos_extension>,
	public IOleCommandTargetImpl<Cdoorfail_zethos_extensionPackage>,
...
// the Cdoorfail_zethos_extensionPackage object will support via QueryInterface
BEGIN_COM_MAP(Cdoorfail_zethos_extensionPackage)
...
VSL_DECLARE_NOT_COPYABLE(Cdoorfail_zethos_extensionPackage)

public:
	Cdoorfail_zethos_extensionPackage()
	{
	}
...
// This exposes Cdoorfail_zethos_extensionPackage for instantiation via DllGetClassObject; however, an instance
// can not be created by CoCreateInstance, as Cdoorfail_zethos_extensionPackage is specifically registered with
// VS, not the the system in general.
OBJECT_ENTRY_AUTO(CLSID_doorfail_zethos_extension, Cdoorfail_zethos_extensionPackage)
